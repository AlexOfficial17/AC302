...
circle.src = "pacman.jpg";
ctx.drawImage(circle, circleX, circleY, circleS);
}
...
function init() {
    ...
    circleY = Math.floor(Math.random()*(HEIGHTwindow.-circleS));
...
function collisionCheck(){
   ...
   circleCollision = false;function.collisionHandle() {
